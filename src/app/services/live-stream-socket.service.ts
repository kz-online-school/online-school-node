...
@Injectable()
export class LiveStreamSocketService {
...
// Set up audio and video regardless of what devices are present.
  ...
  connect(room = 'default') {
    ...
    this.socket.on('get stream', (message) => {
      this.localStream = message;
      this.handleRemoteStream.emit(message);
    });
  }
  ...
  saveStream(message) {
    console.log('Client sending message: ', message);
    this.socket.emit('save stream', message);
  }

  getStream() {
    this.socket.emit('get stream');
  }
